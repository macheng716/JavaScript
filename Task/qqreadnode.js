...
const notifyttt = process.env.QQREAD_NOTIFYTTT || 1// 0为关闭外部推送，1为12 23 点外部推送
const notifyInterval = process.env.QQREAD_NOTIFY_INTERVAL || 2;// 0为关闭通知，1为所有通知，2为12 23 点通知  ， 3为 6 12 18 23 点通知 
